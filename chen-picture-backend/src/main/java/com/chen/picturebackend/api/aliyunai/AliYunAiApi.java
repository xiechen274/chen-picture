package com.chen.picturebackend.api.aliyunai;
...
import com.chen.picturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
...
public class AliYunAiApi {
    ...
    private Logger log = LoggerFactory.getLogger(AliYunAiApi.class);
