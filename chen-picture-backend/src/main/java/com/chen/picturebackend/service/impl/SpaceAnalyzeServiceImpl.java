...
import com.chen.picturebackend.model.entity.dto.space.analyze.SpaceAnalyzeRequest;
...
import com.chen.picturebackend.service.SpaceAnalyzeService;
...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space> implements SpaceAnalyzeService {
     ...
     * 获取空间分类使用分析数据
     *
     * @param spaceCategoryAnalyzeRequest SpaceUsageAnalyzeRequest 请求参数
     * @param loginUser                当前登录用户
     */
    @Override
