...
import com.chen.picturebackend.manager.CosManager;
import com.chen.picturebackend.manager.FileManager;
import com.chen.picturebackend.manager.upload.FilePictureUpload;
import com.chen.picturebackend.manager.upload.PictureUploadTemplate;
import com.chen.picturebackend.manager.upload.UrlPictureUpload;
...
import com.chen.picturebackend.mapper.PictureMapper;
import com.chen.picturebackend.service.SpaceService;
import com.chen.picturebackend.service.UserService;
import com.chen.picturebackend.utils.ColorSimilarUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture> implements PictureService {
    ...
    public Page<PictureVO> getPictureVOPage(Page<Picture> picturePage, HttpServletRequest request) {
        ...
        pictureVOList = pictureList.stream()
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        ...
        if (oldPicture.getReviewStatus().equals(reviewStatus)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "图片状态未改变");
        }
        //更新状态
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        ThrowUtils.throwIf(count > 30 || count == 0 || count < 0, ErrorCode.PARAMS_ERROR, "输入蜀客量不合法");
        // 要抓取的地址
        ...
        int uploadCount = 0;
        for (org.jsoup.nodes.Element imgElement : imgElementList) {
